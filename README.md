# **更新没人看，没人玩系列**
<img src="D:\Desktop\img\no_name_25.jpg" width="638" height = "358">
<p align="center">
...
* [Left4DHooks](https://forums.alliedmods.net/showthread.php?t=321696)
  * 替换了原来的 Left4Downtown2 以及 L4D2 Direct，现在 Left4DHooks 更好的运行在新版本下。
* [Sourcemod 1.10](https://sourcemod.net/downloads.php?branch=stable)
  * 虽然之前已经更新到了 **1.10** 但是一些老旧插件没来得及更新，导致一些功能的缺失，发挥不了新版的特性。
  * 大规模更新导致一些 Cvars 和某些插件失效，所以这次重写了大部分插件代码，以支持最新版本新语法，提高执行率，修复一堆插件内存泄露的问题。
* 某些可有可无的插件被遗弃使用，仅保留常用插件，以减少服务器炸服可能性。
* 由于 “临死一搏” 修复了大部分漏洞和问题，所以我也无法保证更新后的服务器能 100% 适配新版，如有问题麻烦告诉我。
---
